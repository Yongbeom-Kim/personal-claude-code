---
name: design-and-plan-light
description: "Lightweight design and planning workflow with reduced review iterations. Turn ideas into reviewed design specs and implementation plans through collaborative dialogue. Produces artifacts on disk; invoke `implement-from-plan` separately to execute."
---
