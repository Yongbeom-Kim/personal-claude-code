...
const SESSION_DIR = process.env.COMPANION_DIR || '/tmp/visual-companion';
const CONTENT_DIR = path.join(SESSION_DIR, 'content');
const STATE_DIR = path.join(SESSION_DIR, 'state');
let ownerPid = process.env.COMPANION_OWNER_PID ? Number(process.env.COMPANION_OWNER_PID) : null;
