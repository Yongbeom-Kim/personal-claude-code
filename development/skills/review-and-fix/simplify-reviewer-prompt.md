# Simplify Reviewer Prompt Template

Use this template when dispatching the simplify reviewer subagent.

Purpose: Analyze changed code for simplification opportunities and produce structured recommendations. This reviewer does NOT invoke the /simplify skill (which edits files). It performs its own analysis.
